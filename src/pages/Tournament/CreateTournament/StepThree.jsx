...
import { liveStreamingOptions } from '../../../constants/data'
  ...
  return (
    <form onSubmit={saveChanges}>
      ...
      <div className='flex-between' style={{ gap: '1rem' }}>
        ...
        >
          <MenuItem value='LKR'><span role="img" aria-label="Sri Lanka flag">🇱🇰</span></MenuItem>
          <MenuItem value='USD'><span role="img" aria-label="US flag">🇺🇸</span></MenuItem>
        </CustomTextField>
        <CustomTextField
